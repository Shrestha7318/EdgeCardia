...
#define OLED_UPDATE_SAMPLES  125
...
int main(void) {
    ...
    // Configure SysTick for exactly 4ms (250Hz) interval
    ...
    while(1) {
        ...
        // Detect when signal falls back below threshold
        ...
        // Calculate health metrics periodically
        ...
        // Maintain exactly 250Hz sampling rate
        while(!(SysTick->CTRL & SysTick_CTRL_COUNTFLAG_Msk));
    }
}
